    ...
    <div className="w-full">
      ...
      <div className="w-full overflow-x-auto hide-scrollbar">
        ...
        <button
          ...
          className="group w-72 h-44 rounded-xl border border-dashed border-gray-300 bg-white hover:bg-gray-50 transition-all duration-200 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-md focus:outline-none relative"
        ...
        >
          ...
          <p className="text-xs text-gray-400 mt-0.5">Choose account type</p>
